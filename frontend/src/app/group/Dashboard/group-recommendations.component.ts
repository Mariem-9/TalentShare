...
@Component({
    ...
    template: `
        <div class="bg-gradient-to-r from-orange-300 via-amber-300 to-yellow-200 text-white rounded-lg p-4 mb-6 font-extrabold text-2xl text-center drop-shadow-md">
            ...
            <img src="assets/images/group_recommend.jpg" alt="group_recommend" class=" object-contain transition-transform duration-300 hover:scale-105 mx-auto block" />
            <div class="h-4"></div>
        ...
        <p-dialog [(visible)]="displayDialogDetails" [style]="{width: '40em'}"> <app-group-details-widget [group]="groupallowed"
